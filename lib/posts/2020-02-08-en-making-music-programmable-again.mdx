---
path: /en/blog/making-music-programmable-again
date:   2020-02-08
title:  "Making music programmable again"
categories: music gamedev
---

import fasttracker2Uri from "~/assets/img/FastTracker2.png"
import lmmsUri from "~/assets/img/LMMS_PianoRoll.png"
import polyphoneUri from "~/assets/img/Polyphone.png"
...
<figure>
  <audio controls>
    <source src="/res/audio/flamerepellent-sunvox.ogg" type="audio/ogg" />
  </audio>
...
<figure>
  <img alt="FastTracker2 screenshot" src={fasttracker2Uri} />
...
<figure>
  <img alt="LMMS screenshot" src={lmmsUri} />
...
<figure>
  <img alt="Polyphone screenshot" src={polyphoneUri} />
...
If this article resonates with you too, feel free to share, [tweet](https://twitter.com/ngasull/status/1228238628729409536) or [reach out to me](/about#contact-me) and I'll be happy to know what you think and what we can do 🙂 I really believe that the creative community deserves better!

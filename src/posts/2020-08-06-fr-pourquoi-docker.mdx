...
Car oui : c'est vite fait de faire fuiter le port d'une database, et [quand elle n'est pas sécurisée c'est gênant](https://www.bleepingcomputer.com/news/security/new-meow-attack-has-deleted-almost-4-000-unsecured-databases/) 😬
...
Pour mieux comprendre pourquoi et comment bien gérer ses permissions : [voir cet article](/fr/blog/gerer-ses-permissions-avec-docker).
